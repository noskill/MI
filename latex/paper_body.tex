...
action space:motion, rotation \\
observations:angle and distance to near prey, energy level, nearby message\\

additional mechanics:\\
when energy level is low agents actions get lower magnitude and/or become noisy.
...
\subsection{automatic curriculum in two-level agent}
