...
Assume our world model estimates world state with z and tracks history in h. Then we can define information gain about world state as \\
$KL(q(z \mid o, h) \parallel p(z \mid h)) = I(o; z \mid h)$
...
$H(O|h) = E_{z \~ p(z \parallel h)} H(O \parallel z, h) + I(O; Z \mid h)$
...
Similar to other information-based rewards IG is prone to "camping on a toy" issue.
